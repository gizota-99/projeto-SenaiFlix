        ...
        {content &&(
            ...
            <div className="details">
                ...
                <div className="info">
                    ...
                    <p className="sinopse">
                        <strong>Sinopse:</strong> {content.overview}
                    </p>

                    <p className="release">
                        <strong>Lançamento:</strong> {content.releaseDate}
                    </p>

                    <p className="rating">
                        <strong>Avaliação:</strong> {content.rating?.toFixed(1)}/10
                    </p>

                    <Link to='/'>
                        <button className="botaoInfo">Voltar</button>
                    </Link>
